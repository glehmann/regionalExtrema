...
\authoraddress{Department of Medicine, Moansh University, Australia.\\ 
Unit\'e de Biologie du D\'eveloppement et de la Reproduction, Institut National de la Recherche Agronomique, 78350 Jouy-en-Josas, France}
...
\keyword{regional minima, flooding, performance}
% \tableofcontents
...
extrema or not. The flag can be retreive with \code{GetFlat()} method.
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Connectivity = 4]{\includegraphics[scale=5]{reg_min_4_ov.pdf}\label{fig:artificial4}}
\subfigure[Connectivity = 8]{\includegraphics[scale=5]{reg_min_8_ov.pdf}\label{fig:artificial8}}
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Connectivity = 4]{\includegraphics[scale=1]{reg_max_4_ov.pdf}\label{fig:cthead4}}
\subfigure[Connectivity = 8]{\includegraphics[scale=1]{reg_max_8_ov.pdf}\label{fig:cthead8}}
