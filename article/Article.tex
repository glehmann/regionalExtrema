...
\begin{figure}[htbp]
\begin{center}
\subfigure[FullyConnected=False]{\includegraphics[scale=5]{reg_min_4_ov}\label{fig:artificial4}}
\subfigure[FullyConnected=True]{\includegraphics[scale=5]{reg_min_8_ov}\label{fig:artificial8}}
...
\begin{figure}[htbp]
\begin{center}
\subfigure[FullyConnected=False]{\includegraphics[scale=1]{reg_max_4_ov}\label{fig:cthead4}}
\subfigure[FullyConnected=True]{\includegraphics[scale=1]{reg_max_8_ov}\label{fig:cthead8}}
