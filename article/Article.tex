...
Figure~\ref{results} show the labelled (colored) minima on top of the original image.
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=5]{reg_min_ov}
\caption{Regional minima found using the flooding method.\label{results}}
\end{center}
\end{figure}
